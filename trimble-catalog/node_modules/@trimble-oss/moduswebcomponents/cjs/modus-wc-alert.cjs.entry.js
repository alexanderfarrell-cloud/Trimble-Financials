...
const ModusWcAlert = class {
    ...
    getLeadingIcon() {
        if (this.icon) {
            return (index.h("modus-wc-icon", { "custom-class": "modus-wc-alert-icon", name: this.icon, variant: "outlined" }));
        }
        switch (this.variant) {
            case 'error':
                return (index.h("modus-wc-icon", { "custom-class": "modus-wc-alert-icon", name: "alert", variant: "outlined" }));
            case 'success':
                return (index.h("modus-wc-icon", { "custom-class": "modus-wc-alert-icon", name: "check_circle" }));
            case 'warning':
                return (index.h("modus-wc-icon", { "custom-class": "modus-wc-alert-icon", name: "warning", variant: "outlined" }));
            case 'info':
            default:
                return (index.h("modus-wc-icon", { "custom-class": "modus-wc-alert-icon", name: "info", variant: "outlined" }));
        }
    }
    ...
    render() {
        return (index.h(index.Host, { key: '6b8c17a8533ea7c7d9d24e5f90f0f3a1ce3e5bfa' }, index.h("div", Object.assign({ key: '9288fdc6818570cc5b090ac5ad8fe2e2653594cc', class: this.getClasses() }, this.inheritedAttributes), this.getLeadingIcon(), index.h("div", { key: 'b11bc362f74a0db454e84e3977555dc3d7c706e7' }, index.h("div", { key: '585b8356fa235d39304b98ad58a1ba5ae5ff5c70', class: "title" }, this.alertTitle), this.alertDescription && (index.h("div", { key: 'b5ce7525f6789a06b93733628831b3811fae4069', class: "description" }, this.alertDescription)), !this.alertTitle && !this.alertDescription && (index.h("slot", { key: 'b6600d961206555aeb0c43225a05b12331a37635', name: "content" }))), index.h("slot", { key: 'f30e118b87a88405c4ac84bbc40c1ccbd315c1b9', name: "button" }), this.dismissible && (index.h("modus-wc-button", { key: 'dcfd3b06239d15f3c4d2c035bafb2bb68f21a5bf', "aria-label": "notification button", color: "tertiary", size: "sm", slot: "button", variant: "borderless", onButtonClick: () => this.dismissElement() }, index.h("modus-wc-icon", { key: 'a2ce3c13ddd0531af2b80bc4224e1c5dfdd4dffd', "custom-class": "modus-wc-alert-close-icon", name: "close", variant: "outlined" }))))));
    }
...
exports.modus_wc_alert = ModusWcAlert;
