...
const ModusWcHandle = class {
    ...
    renderBarHandle() {
        return index.h("div", { class: "modus-wc-handle-bar" });
    }
    renderButtonHandle() {
        const iconName = this.orientation === 'vertical' ? 'drag_vertical' : 'drag_horizontal';
        return (index.h("div", { class: "modus-wc-handle-button-wrapper" }, index.h("modus-wc-button", { size: this.buttonSize, color: this.buttonColor, variant: this.buttonVariant, shape: "circle", "aria-orientation": this.orientation, role: "separator" }, index.h("modus-wc-icon", { name: iconName, size: "xs" }))));
    }
    render() {
        return (index.h(index.Host, Object.assign({ key: '70c04cc5cd694778806a67994c2f23a9b80b56b8', class: this.getClasses(), role: this.type === 'bar' ? 'separator' : undefined, tabIndex: 0, "aria-orientation": this.type === 'bar' ? this.orientation : undefined }, this.inheritedAttributes), this.type === 'bar'
            ? this.renderBarHandle()
            : this.renderButtonHandle()));
    }
    get el() { return index.getElement(this); }
};
ModusWcHandle.style = modusWcHandleCss;

exports.modus_wc_handle = ModusWcHandle;
