...
const ModusWcTextarea = class {
    ...
    componentWillLoad() {
        ...
        this.inheritedAttributes = Object.assign(Object.assign({}, utils.inheritAriaAttributes(this.el)), utils.inheritAttributes(this.el, ['spellcheck']));
    }
    getClasses() {
    ...
    render() {
        return (index.h(index.Host, { key: '5872672e78191d700f9a1ce18fee8ee6a2a98f03' }, this.label && (index.h("modus-wc-input-label", { key: '4c81f3a774ffe514f541722cd98dadc5c50ddd53', forId: this.inputId, labelText: this.label, required: this.required, size: this.size })), index.h("textarea", Object.assign({ key: 'b9e71aa7b90b2dcc953595c04df21b78485a93e5', "aria-placeholder": this.placeholder, "aria-required": this.required, autocorrect: this.autoCorrect, class: this.getClasses(), disabled: this.disabled, enterkeyhint: this.enterkeyhint, id: this.inputId, maxLength: this.maxLength, minlength: this.minLength, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, placeholder: this.placeholder, readonly: this.readonly, required: this.required, rows: this.rows, tabIndex: this.inputTabIndex, value: this.value }, this.inheritedAttributes)), this.feedback && (index.h("modus-wc-input-feedback", { key: 'c09873ddbca79ac613d2b542348d7e71bfa5c0f4', level: this.feedback.level, message: this.feedback.message, size: this.size }))));
    }
    get el() { return index.getElement(this); }
};
ModusWcTextarea.style = modusWcTextareaCss;

exports.modus_wc_textarea = ModusWcTextarea;
