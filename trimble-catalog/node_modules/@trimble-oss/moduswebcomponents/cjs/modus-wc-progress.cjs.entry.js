...
const ModusWcProgress = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a67a5d23932d0455b824053afe499275373f8d12', class: "modus-wc-progress-container" }, this.variant === 'default' ? (index.h(index.Fragment, null, index.h("progress", Object.assign({ class: this.getClasses() }, valueAttributes, progressAriaAttributes, this.inheritedAttributes)), this.label && index.h("modus-wc-input-label", { labelText: this.label }))) : (index.h("div", Object.assign({ class: this.getClasses(), style: { '--value': `${this.getPercentageValue()}` }, role: "progressbar" }, progressAriaAttributes, this.inheritedAttributes), index.h("span", { class: "modus-wc-radial-progress-label" }, this.label), index.h("slot", null)))));
    }
    get el() { return index.getElement(this); }
};
ModusWcProgress.style = modusWcProgressCss;

exports.modus_wc_progress = ModusWcProgress;
