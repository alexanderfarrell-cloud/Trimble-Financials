...
const ModusWcNumberInput = class {
    ...
    componentWillLoad() {
        ...
        this.inheritedAttributes = Object.assign(Object.assign({}, utils.inheritAriaAttributes(this.el)), utils.inheritAttributes(this.el, ['inputmode']));
    ...
    render() {
        return (index.h(index.Host, { key: '4a3d8e6899f9575ccc6bcd9433b43a9cead566d6', class: this.customClass }, this.label && (index.h("modus-wc-input-label", { key: '3c600ade7cfee0fec6c7b98c9427dd8187172e30', forId: this.inputId, labelText: this.label, required: this.required, size: this.size })), index.h("div", { key: '7f0187b8e34af2474a96e480963d4a23fea41f5e', class: this.getWrapperClasses() }, this.currencySymbol && (index.h("div", { key: '4f1ff2a3bc9e50282534ffdfad10a94cc8ed6a07', class: this.getCurrencyClasses() }, this.currencySymbol)), index.h("input", Object.assign({ key: '32b31bb78ea3af2c4a2e087d8dc4909a66df531d', "aria-required": this.required, autocomplete: this.autoComplete, class: this.getInputClasses(), disabled: this.disabled, id: this.inputId, max: this.max, min: this.min, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, placeholder: this.placeholder, readonly: this.readOnly, required: this.required, step: this.step, tabIndex: this.inputTabIndex, type: this.type, value: this.value }, this.inheritedAttributes))), this.feedback && (index.h("modus-wc-input-feedback", { key: '71b063ed20cc8473579070b6c37b63c2314ef955', level: this.feedback.level, message: this.feedback.message, size: this.size }))));
    }
    get el() { return index.getElement(this); }
};
ModusWcNumberInput.style = modusWcNumberInputCss;

exports.modus_wc_number_input = ModusWcNumberInput;
