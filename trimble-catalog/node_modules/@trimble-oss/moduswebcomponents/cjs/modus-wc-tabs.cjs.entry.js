...
const ModusWcTabs = class {
    ...
    render() {
        const renderTabContent = (tab) => tab.label === undefined ? (tab.icon && index.h("modus-wc-icon", { name: tab.icon, size: this.size })) : (index.h(index.Fragment, null, tab.icon && tab.iconPosition === 'left' && (index.h("modus-wc-icon", { name: tab.icon, size: this.size })), index.h("span", null, tab.label), tab.icon && tab.iconPosition === 'right' && (index.h("modus-wc-icon", { name: tab.icon, size: this.size }))));
        const tabs = this.tabs.map((tab, index$1) => {
            var _a;
            return (index.h("button", { role: "tab", "aria-disabled": tab.disabled, "aria-label": (_a = tab.label) !== null && _a !== void 0 ? _a : tab.icon, class: this.getTabClasses(tab, index$1), disabled: tab.disabled, id: `tab-${index$1}`, onClick: () => this.handleClick(tab, index$1) }, tab.slotName ? (index.h("slot", { name: tab.slotName })) : (renderTabContent(tab))));
        });
        return (index.h(index.Host, { key: '98443823056aa13fc9db4c01b98f036b6dd4f172' }, index.h("div", Object.assign({ key: 'f70e70399000cee9b9025cd02c4617f7b90694e8', role: "tablist", class: this.getClasses() }, this.inheritedAttributes), tabs), index.h("div", { key: '4fc2bee7419c99a2eed288097ff02dece2c92a56', class: "modus-wc-tab-panel", role: "tabpanel", tabIndex: 0 }, this.tabs.map((_, index$1) => (index.h("div", { class: this.activeTabIndex === index$1
                ? 'modus-wc-tab-active'
                : undefined, hidden: this.activeTabIndex !== index$1 }, index.h("slot", { name: `tab-${index$1}` })))))));
    }
    get el() { return index.getElement(this); }
};
ModusWcTabs.style = modusWcTabsCss;

exports.modus_wc_tabs = ModusWcTabs;
