...
const globalCSS = `@supports (color: oklch(0% 0 0)) {
  :root {
 ...
 */
async function ensureDaisyUIInShadow(root) {
    ...
    const supportsAdopted = 'adoptedStyleSheets' in Document.prototype && 'CSSStyleSheet' in window;
    if (supportsAdopted) {
        try {
            ...
            console.warn('adoptedStyleSheets failed, falling back to <style> element:', error);
 ...
 * }
 */
function handleShadowDOMStyles(element) {
...
exports.handleShadowDOMStyles = handleShadowDOMStyles;
