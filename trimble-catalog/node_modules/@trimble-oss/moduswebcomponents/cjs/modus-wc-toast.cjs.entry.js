...
const modusWcToastCss = "";

const ModusWcToast = class {
    constructor(hostRef) {
    ...
    render() {
        return (index.h(index.Host, { key: 'e94c591261fd9d32f89feb19680f54092fabeebe' }, index.h("div", Object.assign({ key: '0221409bd3d21a67376e70c3e1b180e76efaa7b1', class: this.getClasses() }, this.inheritedAttributes), index.h("slot", { key: 'fc565ef2cc0b755dd00df96bdf679518ec672857' }))));
    }
...
exports.modus_wc_toast = ModusWcToast;
