...
const ModusWcButton = class {
    constructor(hostRef) {
        ...
        this.handleKeyDown = (event) => {
            if (!this.disabled &&
                (event.key === utils.KEY.Enter || event.key === utils.KEY.Space)) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0997d9fe1420be288fcb57a9121d16680d54014e' }, index.h("button", Object.assign({ key: '46dc5ab7ab6c6798d11f4294c78ae5f3d5b60f0a', class: this.getClasses(), "aria-pressed": ariaPressed, disabled: this.disabled, onClick: this.handleClick, onKeyDown: this.handleKeyDown, tabIndex: this.disabled ? -1 : 0, type: this.type }, this.inheritedAttributes), index.h("slot", { key: 'aea8cb7f16a4db305d2d8ce2e9fb143ef0b6260f' }))));
    }
    get el() { return index.getElement(this); }
};
ModusWcButton.style = modusWcButtonCss;

exports.modus_wc_button = ModusWcButton;
