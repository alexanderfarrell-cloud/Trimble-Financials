...
const ModusWcChip = class {
    constructor(hostRef) {
        ...
        this.handleKeyUp = (event) => {
            if (!this.disabled && event.key === utils.KEY.Escape) {
                event.preventDefault();
    ...
    render() {
        return (index.h(index.Host, { key: '849006496af3aa6dce20d978369d6ef5bc380fe5' }, index.h("button", Object.assign({ key: '8528c794324f3e5cd8df6d28f40692946a3394b1', "aria-disabled": this.disabled, class: this.getClasses(), disabled: this.disabled, onClick: this.handleChipClick, onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp, tabIndex: 0, type: "button" }, this.inheritedAttributes), index.h("slot", { key: '86ed9314c0abcf86ed0e3d30a0cb66fbdb4dd07d' }), this.label && index.h("span", { key: '14818e14b1b018928d927fe227730e6c0622fc69', class: "modus-wc-chip-label" }, this.label), this.showRemove && (index.h("modus-wc-icon", { key: '32842a30635a8e6c6ac4a882e5409fa6e3823bfa', "custom-class": "modus-wc-chip-remove-icon", name: "close", onClick: this.handleChipRemove })))));
    }
...
const ModusWcLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6c5b5b718f1d42a7d9c8be134216fae275afd400' }, index.h("span", Object.assign({ key: '7e4c1fb12da9565bb8d53cd208921f849f3b57d4', class: this.getClasses(), role: "status", tabindex: -1 }, this.inheritedAttributes))));
    }
    get el() { return index.getElement(this); }
};
ModusWcLoader.style = modusWcLoaderCss;

exports.modus_wc_chip = ModusWcChip;
exports.modus_wc_loader = ModusWcLoader;
