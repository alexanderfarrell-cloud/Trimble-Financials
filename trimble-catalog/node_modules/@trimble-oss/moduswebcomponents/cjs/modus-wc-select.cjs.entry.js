...
const ModusWcSelect = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'eb21d4addc9902599a3ad623fad57160ff9769c1' }, this.label && (index.h("modus-wc-input-label", { key: '048b5766d72c4738282b6e5a486c3686a179bc8d', forId: effectiveId, labelText: this.label, required: this.required, size: this.size })), index.h("select", Object.assign({ key: 'ae944b203f7b1f0966f00bb7b9a47afebf7ed35a', class: this.getClasses(), disabled: this.disabled, id: effectiveId, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, required: this.required, tabindex: this.inputTabIndex }, this.inheritedAttributes), this.options.map((option) => (index.h("option", { disabled: option.disabled, selected: option.value === this.value, value: option.value }, option.label)))), this.feedback && (index.h("modus-wc-input-feedback", { key: 'cafada00cb8818678e2f29c110d447cab325dbe7', level: this.feedback.level, message: this.feedback.message, size: this.size }))));
    }
    get el() { return index.getElement(this); }
};
ModusWcSelect.style = modusWcSelectCss;

exports.modus_wc_select = ModusWcSelect;
