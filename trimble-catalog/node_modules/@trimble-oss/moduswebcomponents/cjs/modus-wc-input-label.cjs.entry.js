...
const ModusWcInputLabel = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a1b1faf45264587fbf52653c0b3c8d1c3371f13d', class: "modus-wc-input-label-host" }, index.h("label", Object.assign({ key: '0ee1830f85c03ee70082e67b2c73224f84b328c3', class: this.getClasses(), htmlFor: this.forId }, this.inheritedAttributes), this.labelText, this.required && (index.h("span", { key: '11b6749526377e5900b5a60df1faba67e86e8337', "aria-hidden": "true", class: "required-indicator" }, '\u00A0*')), this.subLabelText && (index.h("div", { key: '8f403f2fc9f01733b6ac263471875146ff8fe199', class: "modus-wc-input-label-sublabel" }, this.subLabelText)), index.h("slot", { key: '7c0c7ef4d598a29383c21c1378522c588fcd88eb' }))));
    }
