...
const ModusWcModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c1858299cd5b0ee89afca4f4451f4e00c10aafea' }, index.h("dialog", Object.assign({ key: 'd9dd15b045c723065fe4fd1e58f45aece9e185d9', class: this.getClasses(), id: this.modalId }, this.inheritedAttributes), index.h("div", { key: 'a0f53a90214a8abdcf2808e9436b19da7b607c4b', class: `modus-wc-modal-box ${this.fullscreen ? 'modus-wc-modal-fullscreen' : ''}` }, index.h("div", { key: '0f3c81b693fb86125587b54222ff993d29ffd2e0', class: "modus-wc-modal-header modus-wc-text-lg modus-wc-font-bold" }, index.h("slot", { key: 'dfcc4b7ac87c7e1ffb62e765a2d7c843b517e5e9', name: "header" }), index.h("div", { key: '4f12e4cb4e1f6633bffdd0e2b9bfea6379a66903', class: "modus-wc-modal-top-icon-buttons" }, this.showFullscreenToggle && (index.h("modus-wc-button", { key: '15487e73bcca465cf9b9e2c498f1020029eb5779', "aria-label": "Fullscreen toggle", onButtonClick: () => (this.fullscreen = !this.fullscreen), shape: "square", size: "sm", variant: "borderless" }, this.fullscreen ? (index.h(CollapseSolidIcon, null)) : (index.h(ExpandSolidIcon, null)))), this.showClose && (index.h("modus-wc-button", { key: '6768abb022949b2ded539cd6d04d637920358a94', "aria-label": "Close modal", onButtonClick: () => this.closeDialog(), shape: "square", size: "sm", variant: "borderless" }, index.h(closeSolid_icon.CloseSolidIcon, { key: '3b9830db30966927bd4173c440d01e6a939acf57' }))))), index.h("div", { key: 'c595958bd6a5c63ac6429dc45be0215d1d6342d5', class: "modus-wc-modal-content modus-wc-py-4" }, index.h("slot", { key: '2efe016bd2e5cf3e50c14ef89c40580180aa7583', name: "content" })), index.h("div", { key: '81db4a915fb9250e9aaacbf7d52d046ba1a096b8', class: "modus-wc-modal-action" }, index.h("slot", { key: '2a1d3bb847afc3bda4b662a231013811b5fd8d2f', name: "footer" }))), this.backdrop === 'default' && (index.h("form", { key: 'ff7c4cbdac9246335d5cf446cf3c8576a103d9da', method: "dialog", class: "modus-wc-modal-backdrop" }, index.h("button", { key: '379cff51417e4a738a44d9c659b41831c3730462' }, "close"))))));
    }
