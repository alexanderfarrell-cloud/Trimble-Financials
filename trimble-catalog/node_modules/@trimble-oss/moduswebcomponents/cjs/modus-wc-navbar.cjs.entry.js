...
var searchSolid_icon = require('./search-solid.icon-DyDQPY-F.js');
...
const ModusWcNavbar = class {
    constructor(hostRef) {
        ...
        this.aiClick = index.createEvent(this, "aiClick");
        this.appsClick = index.createEvent(this, "appsClick");
        this.appsMenuOpenChange = index.createEvent(this, "appsMenuOpenChange");
        this.condensedMenuOpenChange = index.createEvent(this, "condensedMenuOpenChange");
        this.helpClick = index.createEvent(this, "helpClick");
        this.mainMenuOpenChange = index.createEvent(this, "mainMenuOpenChange");
        this.myTrimbleClick = index.createEvent(this, "myTrimbleClick");
        this.notificationsClick = index.createEvent(this, "notificationsClick");
        this.notificationsMenuOpenChange = index.createEvent(this, "notificationsMenuOpenChange");
        this.searchChange = index.createEvent(this, "searchChange");
        this.searchClick = index.createEvent(this, "searchClick");
        this.searchInputOpenChange = index.createEvent(this, "searchInputOpenChange");
        this.signOutClick = index.createEvent(this, "signOutClick");
        this.trimbleLogoClick = index.createEvent(this, "trimbleLogoClick");
        this.userMenuOpenChange = index.createEvent(this, "userMenuOpenChange");
    ...
    render() {
        ...
        return (index.h(index.Host, Object.assign({ key: 'a96c0a2319d2f2ef4a88a21526f3ae25c68a9ae7', class: this.getClasses() }, this.inheritedAttributes), index.h("modus-wc-toolbar", { key: 'd9c07e6f478ad4860b18df7c599602e13d780806' }, index.h("div", { key: 'ca4a0291a3e4bbfd039ee14309743645776b722e', slot: "start" }, ((_e = this.visibility) === null || _e === void 0 ? void 0 : _e.mainMenu) && (index.h(index.Fragment, { key: 'b6331e0655045949275e66468e67fa842ace3ea8' }, index.h("modus-wc-button", { key: 'b6be968a376e2b14d636302704d3a3f89541253e', "aria-label": "Main menu", onButtonClick: this.toggleMainMenu, shape: "square", size: "sm", variant: "borderless" }, index.h(MenuSolidIcon, { key: 'df192f45e0b87aced69ca6fe97beeca559f938cf' })), index.h("div", { key: 'a41e65cd3cf4db1779bbbf3996818479ff0ef251', class: `main-menu ${this.mainMenuOpen ? 'visible' : 'hidden'}`, ref: (el) => (this.menuRef = el) }, index.h("slot", { key: 'e24743884b7d9069d71daf361755f51aba9996d9', name: "main-menu" })))), ((_f = this.visibility) === null || _f === void 0 ? void 0 : _f.logo) !== false && (index.h("modus-wc-button", { key: '7069e5c3a245ade840093907959860fcfa0fd84c', "aria-label": `${accessibleName} logo`, customClass: "logo", onButtonClick: this.handleTrimbleLogoClick, size: "sm", variant: "borderless" }, index.h("modus-wc-logo", { key: '687aa275911464af35b570dc4a6810f9a78ba1df', name: this.logoName || 'trimble', emblem: this.condensed }))), index.h("slot", { key: 'e49084b82343f0d161dba0975227ff452346c541', name: "start" })), index.h("div", { key: '966773d1b7330f25726cff5606fa2e498b301a1f', slot: "center" }, index.h("slot", { key: '40e4719991c6d35fbd8ae2d6595238bd733edc61', name: "center" })), index.h("div", { key: 'b59fa42ff2daa381c606177e96b246eb824b99ba', slot: "end" }, index.h("slot", { key: 'f38a0b1fcee9a8693ef0b938ff1a5d278733d9c8', name: "end" }), ((_g = this.visibility) === null || _g === void 0 ? void 0 : _g.ai) && (index.h(index.Fragment, { key: '672c2710f8870ced86378538d69630017faee7ff' }, index.h("modus-wc-button", { key: 'c000cc90884e74e259d5635434096efc27dc6a41', "aria-label": "AI assistant", customClass: "ai", onButtonClick: this.handleAiClick, shape: "square", size: "sm", variant: "borderless" }, this.isLight ? index.h(AiLightIcon, null) : index.h(AiDarkIcon, null)))), this.condensed && condensedHasItems && (index.h(index.Fragment, { key: 'b23dfa323a818cbd20d3c7e98e37b724dbc00226' }, index.h("modus-wc-button", { key: '60df9dde5da5e66dcfaf55863b603910c859fb6e', "aria-label": "More options", onButtonClick: this.toggleCondensedMenu, shape: "square", size: "sm", variant: "borderless" }, index.h(MoreVerticalSolidIcon, { key: '7e4a6cf4dabf5d9ea91d18915ce6746fb2433c12' })), this.condensedMenuOpen && (index.h("modus-wc-menu", { key: '686ee34b1283158eaeb65dcd47664fb7db3b7d60', bordered: true, customClass: "condense-menu", ref: (el) => (this.condensedMenuRef = el) }, ((_h = this.visibility) === null || _h === void 0 ? void 0 : _h.search) && (index.h("modus-wc-menu-item", { key: 'aaf51a3ef070f7a2cee76e5346e745190fdf75f1', label: ((_j = this.textOverrides) === null || _j === void 0 ? void 0 : _j.search) || 'Search', onItemSelect: () => this.handleSearchClick(), value: "search" })), ((_k = this.visibility) === null || _k === void 0 ? void 0 : _k.notifications) && (index.h("modus-wc-menu-item", { key: '1bbfb98c1aaea55c28824afb32d3530a8fba38e8', label: ((_l = this.textOverrides) === null || _l === void 0 ? void 0 : _l.notifications) || 'Notifications', onItemSelect: () => this.handleNotificationsClick(), value: "notifications" })), ((_m = this.visibility) === null || _m === void 0 ? void 0 : _m.help) && (index.h("modus-wc-menu-item", { key: '3c729efc88d91bb40c46688e14c0c2ae84d49cb2', label: ((_o = this.textOverrides) === null || _o === void 0 ? void 0 : _o.help) || 'Help', onItemSelect: () => this.handleHelpClick(), value: "help" })), ((_p = this.visibility) === null || _p === void 0 ? void 0 : _p.apps) && (index.h("modus-wc-menu-item", { key: 'e622c9e085472d47f0a914bde52645f8d2a7f00e', label: ((_q = this.textOverrides) === null || _q === void 0 ? void 0 : _q.apps) || 'Apps', onItemSelect: () => this.handleAppsClick(), value: "apps" })))))), ((_r = this.visibility) === null || _r === void 0 ? void 0 : _r.search) && !this.condensed && (index.h(index.Fragment, { key: '89dfb9e22e604cbe60dba111b818b442cbc291e9' }, ((_s = this.visibility) === null || _s === void 0 ? void 0 : _s.searchInput) && this.searchInputOpen && (index.h("modus-wc-text-input", { key: '004b55ac6610f7aaaa3bb5cc9e71a1e78e67cd93', includeClear: true, includeSearch: true, onInputChange: this.handleSearchChange, placeholder: ((_t = this.textOverrides) === null || _t === void 0 ? void 0 : _t.search) || 'Search', size: "sm", value: this.searchValue })), index.h("modus-wc-button", { key: 'c25e08a4ca0d65437aa47eb3885db97b40a5975f', "aria-label": "Search", onButtonClick: this.handleSearchClick, shape: "square", size: "sm", variant: "borderless" }, index.h(searchSolid_icon.SearchSolidIcon, { key: '60d6121651269f4b8d58d4cabffa694aef808684' })))), ((_u = this.visibility) === null || _u === void 0 ? void 0 : _u.notifications) && !this.condensed && (index.h(index.Fragment, { key: 'e23fbf1ecf390eb115945e9c5d81f8ccc3f08b16' }, index.h("modus-wc-button", { key: '81a7d2ff8e8ce919d4baaeaa9c855b8ccb29a496', "aria-label": "Notifications", onButtonClick: this.handleNotificationsClick, shape: "square", size: "sm", variant: "borderless" }, index.h(NotificationsSolidIcon, { key: '0bb481ee4264decd8554afa0f411e289c084456c' })), index.h("div", { key: '180f55b4c89a9ece7c3c9464d2fe017aa9ac2525', class: `notifications ${this.notificationsMenuOpen ? 'visible' : 'hidden'}`, ref: (el) => (this.notificationsRef = el) }, index.h("slot", { key: 'dc3c02f0a431740b77add477214d83edd1ead726', name: "notifications" })))), ((_v = this.visibility) === null || _v === void 0 ? void 0 : _v.help) && !this.condensed && (index.h("modus-wc-button", { key: 'c846db586e982dec0364b79cdf3b13e4019b1414', "aria-label": "Help", onButtonClick: this.handleHelpClick, shape: "square", size: "sm", variant: "borderless" }, index.h(HelpSolidIcon, { key: '8a86189c80fa17d9ad420eb0ed9ae98e368ac935' }))), ((_w = this.visibility) === null || _w === void 0 ? void 0 : _w.apps) && !this.condensed && (index.h(index.Fragment, { key: 'aa2bc840fab19c8aa2c2c77b668493e04671973f' }, index.h("modus-wc-button", { key: 'c680be3d30780e247c0330abe26273fa8ba25c63', "aria-label": "Apps", onButtonClick: this.handleAppsClick, shape: "square", size: "sm", variant: "borderless" }, index.h(AppsSolidIcon, { key: '42047b4d08693b4a16d0e3b56cadac31b2528d82' })), index.h("div", { key: 'c7ff74df644692b970acf2a4eec6dea83db05147', class: `apps ${this.appsMenuOpen ? 'visible' : 'hidden'}`, ref: (el) => (this.appsRef = el) }, index.h("slot", { key: '592395ca8508d30800561d42e60541eb409f1e2b', name: "apps" })))), ((_x = this.visibility) === null || _x === void 0 ? void 0 : _x.user) && (index.h(index.Fragment, { key: '0a94e30ed9398bf8e98badd32ffb6218637fdcad' }, index.h("modus-wc-button", { key: '849bf9b2e3bcb3256c800f3aba3a60f35651153a', "aria-label": "User profile", customClass: "user-button", onButtonClick: this.toggleUser, shape: "circle", size: "sm", variant: "borderless" }, index.h("modus-wc-avatar", { key: '4013ddeea80555a4458f852ab1c6882588fff5bf', alt: ((_y = this.userCard) === null || _y === void 0 ? void 0 : _y.avatarAlt) || '', imgSrc: (_z = this.userCard) === null || _z === void 0 ? void 0 : _z.avatarSrc, initials: (_0 = this.userCard) === null || _0 === void 0 ? void 0 : _0.name, size: "xs" })), index.h("div", { key: '476e159c4fdbe1c5ad737978b71b7db03d91d408', class: `user ${this.userMenuOpen ? 'visible' : 'hidden'}`, ref: (el) => (this.userRef = el) }, index.h("modus-wc-card", { key: 'c3d4d4303f987e1df8f351176812ebbb1c177e0d' }, index.h("div", { key: '2316ec90fb1caa232dd584db490d1be837940654', slot: "header" }, index.h("modus-wc-avatar", { key: '52811d868a45c3d5902819cabd6a06a426dbf944', alt: ((_1 = this.userCard) === null || _1 === void 0 ? void 0 : _1.avatarAlt) || '', imgSrc: (_2 = this.userCard) === null || _2 === void 0 ? void 0 : _2.avatarSrc, initials: (_3 = this.userCard) === null || _3 === void 0 ? void 0 : _3.name })), index.h("div", { key: 'db820f5379b1de56c8f6a7e16de8d9d80247a71a', slot: "title" }, (_4 = this.userCard) === null || _4 === void 0 ? void 0 : _4.name), index.h("div", { key: '79190afffffa0cc62aebf099acbe8637a15c4ffa' }, (_5 = this.userCard) === null || _5 === void 0 ? void 0 : _5.email), index.h("div", { key: '2b87dcebe0948a6a19ca6f63b75d640a37591c20', slot: "actions" }, index.h("modus-wc-button", { key: 'a2dbe18354bc72eede0eaece239df961686dcfbc', customClass: "my-trimble", onButtonClick: this.handleMyTrimbleClick }, ((_6 = this.userCard) === null || _6 === void 0 ? void 0 : _6.myTrimbleButton) || 'Access MyTrimble')), index.h("div", { key: '30f50417ac0d1ad4767d05172085162fdfd63f0a', slot: "footer" }, index.h("modus-wc-button", { key: '5019a97641df187bb58a79cdb16e0b179fe5a069', customClass: "sign-out", onButtonClick: this.handleSignOutClick, variant: "borderless" }, ((_7 = this.userCard) === null || _7 === void 0 ? void 0 : _7.signOutButton) || 'Sign out'))))))))));
    }
