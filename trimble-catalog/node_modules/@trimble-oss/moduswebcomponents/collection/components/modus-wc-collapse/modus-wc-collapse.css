...
modus-wc-collapse .modus-wc-collapse summary > .modus-wc-inline-flex.modus-wc-items-center > modus-wc-icon {
  height: 24px;
...
modus-wc-collapse .modus-wc-collapse.modus-wc-collapse-arrow.modus-wc-collapse-open {
  font-size: var(--modus-wc-font-size-md);
}
modus-wc-collapse .modus-wc-collapse.modus-wc-collapse-arrow.modus-wc-collapse-open .modus-wc-collapse-content {
  padding: 0 var(--modus-wc-spacing-lg) var(--modus-wc-spacing-md) var(--modus-wc-spacing-lg);
}
