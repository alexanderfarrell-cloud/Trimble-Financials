...
const meta = {
    ...
    decorators: [
        ...
        (story, context) => {
            ...
            const { tabs } = (_a = context.args) !== null && _a !== void 0 ? _a : {};
...
const normalizeTabs = (tabs) => {
    return tabs.map((tab) => {
        const normalized = Object.assign({}, tab);
...
</modus-wc-tabs>${getSourceCode(args.tabs)}`,
            },
        },
    },
    render: (args) => {
...
export const ActiveAndDisabled = Object.assign(Object.assign({}, Template), { args: {
        activeTabIndex: 1,
        tabs: [
            { label: 'Normal' },
            { label: 'Active' },
...
export const Icons = Object.assign(Object.assign({}, Template), { args: {
        tabs: [
            { icon: 'home' },
