...
export const CustomMenuAndSlots = {
    render: (args) => {
        function toggleCustomUserMenu(e) {
            var _a;
            const customIcon = e.currentTarget;
            const menu = (_a = customIcon.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('#custom-user-menu');
        ...
        if (!customElements.get('navbar-shadow-host')) {
            const NavbarShadowHost = createShadowHostClass({
                ...
                propsMapper: (v, el) => {
                    ...
                    navbarEl.searchDebounceMs = (_a = v['search-debounce-ms']) !== null && _a !== void 0 ? _a : 300;
                    navbarEl.textOverrides = v['text-overrides'];
                    navbarEl.userCard = v['user-card'];
                    navbarEl.visibility = v.visibility;
