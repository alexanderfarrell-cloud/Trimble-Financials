import { r as registerInstance, c as createEvent, h, F as Fragment, H as Host, g as getElement } from './index-D5XAQERj.js';
import { h as handleShadowDOMStyles } from './base-component-CKNBKeF3.js';
import { g as generateRandomId, i as inheritAriaAttributes } from './utils-BFec1ApF.js';
...
const ModusWcCollapse = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f096cd2fe3aef17701cdfbe716f91d585a5ced46' }, h("details", Object.assign({ key: 'f54d0fd96bece4c26995dd752c0f06a5519d39f7', class: this.getOuterDivClasses(), open: this.expanded, onToggle: this.handleToggle, ref: (el) => (this.detailsRef = el) }, this.inheritedAttributes), h("summary", { key: '53b5f593601bb992bbbfbad84f4ad93301e95fb7', class: this.getTitleClasses(), id: titleId }, this.options ? (h(Fragment, null, h("div", { class: this.getTitleChildDivClasses() }, this.options.icon && (h("modus-wc-icon", { "aria-label": this.options.iconAriaLabel, decorative: true, name: this.options.icon, size: this.options.size })), this.options.title), this.options.description && (h("div", { class: this.getDescriptionDivClasses() }, this.options.description)))) : (h("slot", { name: "header" }))), h("div", { key: '174f108ec846bf76157b695a516b5b82b0a2b42f', "aria-labelledby": titleId, class: "modus-wc-collapse-content modus-wc-cursor-default", id: contentId }, h("slot", { key: '004a91b9ef8066978f7e255ca2c1b4e7232a6534', name: "content" })))));
    }
...
export { ModusWcCollapse as modus_wc_collapse };
