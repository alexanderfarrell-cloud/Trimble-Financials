...
import { D as DAISY_TO_MODUS_LABEL_SIZE } from './constants-DZXd_sgn.js';
import { i as inheritAriaAttributes } from './utils-BFec1ApF.js';

const convertPropsToClasses = (props) => {
    let classes = '';
...
const ModusWcSwitch = class {
    ...
    render() {
        ...
        return (h(Host, { key: '350f1a7da0fd8dc5f3327a487358db01a2437673', class: "modus-wc-switch-host" }, h("input", Object.assign({ key: '3a6d23af2dbceb5695c998a1a7a56d4108c49508', "aria-checked": this.indeterminate ? 'mixed' : this.value, "aria-disabled": this.disabled, checked: this.value, class: this.getClasses(), disabled: this.disabled, id: this.inputId, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, required: this.required, role: "switch", tabIndex: this.inputTabIndex, type: "checkbox" }, this.inheritedAttributes)), this.label && (h("modus-wc-input-label", { key: 'b50a3c9a1d4e82e02d916a7a66b06cecda5a0e05', forId: this.inputId, labelText: this.label, required: this.required, size: labelSize }))));
    }
    get el() { return getElement(this); }
};
ModusWcSwitch.style = modusWcSwitchCss;

export { ModusWcSwitch as modus_wc_switch };
