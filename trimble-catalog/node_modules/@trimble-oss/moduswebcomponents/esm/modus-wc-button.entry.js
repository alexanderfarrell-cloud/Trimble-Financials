import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-D5XAQERj.js';
import { h as handleShadowDOMStyles } from './base-component-CKNBKeF3.js';
import { K as KEY, i as inheritAriaAttributes } from './utils-BFec1ApF.js';

const convertPropsToClasses = ({ color, disabled, fullWidth, pressed, shape, size, variant, }) => {
    let classes = '';
    if (color) {
        switch (color) {
            case 'primary':
...
const ModusWcButton = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0997d9fe1420be288fcb57a9121d16680d54014e' }, h("button", Object.assign({ key: '46dc5ab7ab6c6798d11f4294c78ae5f3d5b60f0a', class: this.getClasses(), "aria-pressed": ariaPressed, disabled: this.disabled, onClick: this.handleClick, onKeyDown: this.handleKeyDown, tabIndex: this.disabled ? -1 : 0, type: this.type }, this.inheritedAttributes), h("slot", { key: 'aea8cb7f16a4db305d2d8ce2e9fb143ef0b6260f' }))));
    }
    get el() { return getElement(this); }
};
ModusWcButton.style = modusWcButtonCss;

export { ModusWcButton as modus_wc_button };
