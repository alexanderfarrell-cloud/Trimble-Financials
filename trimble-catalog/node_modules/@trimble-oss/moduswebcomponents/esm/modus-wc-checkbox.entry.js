...
const ModusWcCheckbox = class {
    ...
    render() {
        return (h(Host, { key: '4ce731460b820a7e804c2b945afc96da4548a8d3', class: "modus-wc-checkbox-host" }, h("input", Object.assign({ key: '6001d9d596d53ea75131e5d929b9fec35355b55d', "aria-checked": this.indeterminate ? 'mixed' : this.value, "aria-disabled": this.disabled, checked: this.value, class: this.getClasses(), disabled: this.disabled, id: this.inputId, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, required: this.required, tabIndex: this.inputTabIndex, type: "checkbox" }, this.inheritedAttributes)), this.label && (h("modus-wc-input-label", { key: '392d9e2bcd3d89f2e566684b6ce95b1d8211200d', forId: this.inputId, labelText: this.label, required: this.required, size: this.size }))));
    }
