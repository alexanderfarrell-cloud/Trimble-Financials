...
const ModusWcBreadcrumbs = class {
    ...
    render() {
        return (h(Host, { key: '9962a34f1dac82f1f3e7556d406c9d4863c014ad' }, h("nav", Object.assign({ key: '67435e57f382ff45f8698202aa12eb65e6d6994c', class: this.getClasses() }, this.inheritedAttributes), h("ol", { key: 'aeeb9c2fe11832c1b307821da45851e705b0044a' }, this.items.map((item, index) => {
            const isCurrentPage = index === this.items.length - 1;
            return (h("li", Object.assign({ key: item.label }, (isCurrentPage ? { 'aria-current': 'page' } : {})), isCurrentPage ? (h("span", null, item.label)) : (h("a", { href: item.url, onClick: (event) => this.handleClick(event, item) }, item.label))));
        })))));
    }
...
export { ModusWcBreadcrumbs as modus_wc_breadcrumbs };
