import { h, F as Fragment, p as proxyCustomElement, H, d as createEvent, c as Host } from './p-X1tirp06.js';
import { S as SearchSolidIcon, d as defineCustomElement$3 } from './p-CtRj0TZD.js';
import { h as handleShadowDOMStyles } from './p-CKNBKeF3.js';
import { K as KEY, i as inheritAriaAttributes } from './p-CPG9FZRU.js';
import { C as CloseSolidIcon } from './p-BOyjaZyQ.js';
import { d as defineCustomElement$c } from './p-DRd0Bis4.js';
import { d as defineCustomElement$b } from './p-CeZm3cg9.js';
import { d as defineCustomElement$a } from './p-pcThL0VX.js';
import { d as defineCustomElement$9 } from './p-vnbqBzVH.js';
import { d as defineCustomElement$8 } from './p-Bfy1MXxF.js';
import { d as defineCustomElement$7 } from './p-CqPlhPZ4.js';
import { d as defineCustomElement$6 } from './p-B4tU_XSC.js';
import { d as defineCustomElement$5 } from './p-DsNHJf57.js';
import { d as defineCustomElement$4 } from './p-BvSTk6wy.js';
import { d as defineCustomElement$2 } from './p-C5jBPzA7.js';
...
function processItemSelection(item, params) {
    ...
    if (params.multiSelect) {
        ...
        if (isCurrentlySelected || isInSelectionOrder) {
            ...
            updatedItems = [
                ...params.items.map((menuItem) => (Object.assign(Object.assign({}, menuItem), { selected: menuItem.value === item.value ? false : menuItem.selected, focused: params.leaveMenuOpen ? menuItem.value === item.value : false }))),
            ];
            // Remove from selection order
            updatedSelectionOrder = params.selectionOrder.filter((value) => value !== item.value);
            return {
                updatedItems,
                updatedValue: '',
...
function renderClearButton(params) {
    ...
    return (h("modus-wc-button", { onClick: params.onClearAll, variant: "borderless", color: "tertiary", "aria-label": "Clear all", disabled: params.disabled || params.readOnly, size: "xs", shape: "circle", type: "button" },
...
function renderExpandCollapseButton(params) {
    ...
    return (h("modus-wc-button", { "custom-class": `modus-wc-autocomplete-expand-button ${params.isChipsExpanded ? 'expanded' : ''}`, onClick: params.onToggleExpansion, variant: "borderless", color: "tertiary", "aria-label": params.isChipsExpanded
            ? 'Collapse chips'
...
function renderInput(params) {
    return (h("modus-wc-text-input", Object.assign({ autoComplete: params.autoComplete, bordered: params.bordered && !params.multiSelect, customClass: params.customClass, disabled: params.disabled, feedback: !params.multiSelect ? params.feedback : undefined, includeClear: !params.multiSelect && params.includeClear, includeSearch: !params.multiSelect && params.includeSearch, inputId: params.inputId, inputTabIndex: params.inputTabIndex, name: params.name, onClearClick: params.onClear, onInputBlur: params.onBlur, onInputChange: params.onChange, onInputFocus: params.onFocus, placeholder: params.placeholder, readOnly: params.readOnly, required: params.required, size: params.size, value: params.value }, params.inheritedAttributes), params.customIconSlot ? h("slot", { name: "custom-icon" }) : undefined));
}
...
const ModusWcAutocomplete$1 = /*@__PURE__*/ proxyCustomElement(class ModusWcAutocomplete extends H {
    ...
    scrollToOptionSelected() {
        ...
        requestAnimationFrame(() => {
            ...
            if (menuEl) {
                const targetItem = menuEl.querySelector('.modus-wc-menu-item-active');
    ...
    handleArrowDown() {
        ...
        handleArrowDown({
            ...
            onSetMenuVisible: (visible) => {
                ...
                if (visible && ((_a = this.items) === null || _a === void 0 ? void 0 : _a.some((item) => item.selected))) {
                    this.scrollToOptionSelected();
                    this.showFeedback = false;
                }
                else if (visible) {
    ...
    render() {
        ...
        return (h(Host, { key: '8a8319d85917b6ad4dc57cea3a5ec96201fd8f29', class: this.getClasses(), style: cssVariables }, this.label && (h("modus-wc-input-label", { key: 'c6ce1ddf614242ea164dc8c0febc0022079c3ef9', customClass: this.feedback && (this.showFeedback || this.menuVisible)
                ? `modus-wc-input-label--${this.feedback.level}`
                : '', forId: this.inputId, labelText: this.label, required: this.required, size: this.size })), this.multiSelect ? (h("div", { class: this.getMultiSelectClasses() }, this.includeSearch && (h(SearchSolidIcon, { className: "modus-wc-autocomplete-search-icon" })), h("div", { class: "modus-wc-autocomplete-content" }, renderChips({
            selectionOrder: this.selectionOrder,
            items: this.items,
            ...
            onFocus: this.handleFocus,
        }))), !this.multiSelect && this.feedback && this.showFeedback && (h("modus-wc-input-feedback", { key: '90c0f2036ce404b1a255d3590e38719858f7a090', level: this.feedback.level, message: this.feedback.message, size: this.size })), hasSlottedMenuItems ? (
        ...
        this.menuVisible && (h("modus-wc-menu", { "aria-label": "Autocomplete menu", bordered: this.bordered, class: "menu-visible", onMenuFocusout: this.handleMenuFocusout, onMouseDown: (e) => e.preventDefault(), size: this.size }, renderMenuItems({
            ...
            hasSlottedContent: hasSlottedMenuItems,
            onItemSelect: this.handleItemSelectByValue,
        }), h("slot", { name: "menu-items" })))), this.multiSelect && this.feedback && this.showFeedback && (h("modus-wc-input-feedback", { key: 'e7c72c9867b3635ffe1c3a34363aaa7edf6f4b80', level: this.feedback.level, message: this.feedback.message, size: this.size }))));
    }
    get el() { return this; }
    ...
    static get style() { return modusWcAutocompleteCss; }
}, [4, "modus-wc-autocomplete", {
        ...
        "items": [16],
        "label": [1],
        "leaveMenuOpen": [4, "leave-menu-open"],
        "minChars": [2, "min-chars"],
        "multiSelect": [4, "multi-select"],
        "name": [1],
        "noResults": [16, "no-results"],
        "placeholder": [1],
        "readOnly": [4, "read-only"],
        "required": [4],
        "showMenuOnFocus": [4, "show-menu-on-focus"],
        "size": [1],
        "showSpinner": [4, "show-spinner"],
        "value": [1537],
        "maxChips": [2, "max-chips"],
        "customItemSelect": [16, "custom-item-select"],
        "customInputChange": [16, "custom-input-change"],
        "customKeyDown": [16, "custom-key-down"],
        "customBlur": [16, "custom-blur"],
        "minInputWidth": [2, "min-input-width"],
        "menuVisible": [32],
        "isChipsExpanded": [32],
        "initialNavigation": [32],
        "filteredItems": [32],
        "selectionOrder": [32],
        "searchText": [32],
        "showFeedback": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["modus-wc-autocomplete", "modus-wc-button", "modus-wc-checkbox", "modus-wc-chip", "modus-wc-icon", "modus-wc-input-feedback", "modus-wc-input-label", "modus-wc-loader", "modus-wc-menu", "modus-wc-menu-item", "modus-wc-text-input", "modus-wc-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-wc-autocomplete":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusWcAutocomplete$1);
            }
            break;
...
const ModusWcAutocomplete = ModusWcAutocomplete$1;
const defineCustomElement = defineCustomElement$1;

export { ModusWcAutocomplete, defineCustomElement };
