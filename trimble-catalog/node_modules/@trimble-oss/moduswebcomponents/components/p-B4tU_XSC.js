...
const ModusWcLoader = /*@__PURE__*/ proxyCustomElement(class ModusWcLoader extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    get el() { return this; }
    static get style() { return modusWcLoaderCss; }
}, [0, "modus-wc-loader", {
        "color": [1],
...
function defineCustomElement() {
    ...
    const components = ["modus-wc-loader"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-wc-loader":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusWcLoader);
            }
            break;
    } });
}

export { ModusWcLoader as M, defineCustomElement as d };
