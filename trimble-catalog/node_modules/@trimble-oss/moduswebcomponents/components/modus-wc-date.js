...
import { d as defineCustomElement$6 } from './p-DRd0Bis4.js';
import { d as defineCustomElement$5 } from './p-vnbqBzVH.js';
import { d as defineCustomElement$4 } from './p-Bfy1MXxF.js';
import { d as defineCustomElement$3 } from './p-CqPlhPZ4.js';
...
const ModusWcDate$1 = /*@__PURE__*/ proxyCustomElement(class ModusWcDate extends H {
    constructor() {
        ...
        this.handleInput = (event) => {
            var _a, _b;
            const rawValue = (_b = (_a = event.target) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : '';
    ...
    getLocaleFormatGuide() {
        ...
        const parts = new Intl.DateTimeFormat(this.locale, options).formatToParts(new Date(2026, 11, 31));
        return parts
            .map((part) => {
            switch (part.type) {
                case 'day':
    ...
    parseISODate(value) {
        ...
        if (isoMatch) {
            ...
            if (date.getFullYear() === Number(isoMatch[1]) &&
        ...
        if (guide.includes('MMM')) {
            ...
            if (!mmmMatch)
                return undefined;
            const monthIdx = MONTH_SHORT_NAMES.findIndex((m) => m.toLowerCase() === mmmMatch[1].toLowerCase());
            if (monthIdx === -1)
                return undefined;
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: 'ad188591ea7a87365f804252db6790e752d08391' }, this.label && (h("modus-wc-input-label", { key: '113a0f41188e7f0cf8eecea7916cf4903d3eacd0', forId: this.inputId, labelText: this.label, required: this.required, size: this.size })), h("div", { key: 'db03a6561049215aa4b29e89e0b091f348cfc283', class: "date-input-container" }, h("input", Object.assign({ key: '9b4f577fbf354fb3bb831d414c02282d65ffda69', ref: (el) => (this.inputRef = el), "aria-disabled": this.disabled, class: this.getClasses(), disabled: this.disabled, id: this.inputId, name: this.name, onBlur: this.handleBlur, onFocus: this.handleFocus, onInput: this.handleInput, onKeyDown: this.handleInputKeyDown, placeholder: this.effectiveFormat, readonly: this.readOnly, required: this.required, tabIndex: this.inputTabIndex, type: "text", value: this.hasFocus
                ? ((_b = (_a = this.inputRef) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : '')
                : this.inputDisplayValue }, this.inheritedAttributes)), h("modus-wc-button", { key: 'beb3e7fff09a2bcd546f9c3bf8f1a495c8a51ea4', "aria-label": "Open calendar", disabled: this.disabled || this.readOnly, variant: "borderless", shape: "circle", size: "xs", color: "tertiary", class: "calendar-icon-button", onButtonClick: 
            // istanbul ignore next (unreachable code)
            () => this.toggleCalendar() }, h("modus-wc-icon", { key: '581777095a613a448fc2270b05af839468b1e205', name: "calendar_blank", size: "sm" }))), this.showCalendar && (h("div", { key: 'ad7daaa70009a975c071942f684038d9e9fa8283', ref: (el) => (this.calendarRef = el), class: `calendar-container${this.showWeekNumbers ? ' has-week-numbers' : ''}` }, this.renderCalendarHeader(), this.renderCalendarBody())), this.feedback && (h("modus-wc-input-feedback", { key: 'e41d0c5f861abf8d9519c0e70671a416390897d5', level: this.feedback.level, message: this.feedback.message, size: this.size }))));
    }
    get el() { return this; }
    ...
    static get style() { return modusWcDateCss; }
        ...
        "format": [1],
        "value": [1537],
        "weekStartDay": [1, "week-start-day"],
        "showWeekNumbers": [4, "show-week-numbers"],
        "showCalendar": [32],
        "calendar": [32],
        "focusedDateIndex": [32]
    }, [[4, "click", "handleClickOutside"], [4, "keydown", "handleEscapeKey"], [0, "keydown", "handleArrowKeys"]], {
        "format": ["handleFormatChange"],
        "min": ["handleMinChange"],
        "max": ["handleMaxChange"],
        "value": ["handleValueChange"],
...
function defineCustomElement$1() {
    ...
    const components = ["modus-wc-date", "modus-wc-button", "modus-wc-icon", "modus-wc-input-feedback", "modus-wc-input-label", "modus-wc-select"];
