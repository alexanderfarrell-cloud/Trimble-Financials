import { h, p as proxyCustomElement, H, d as createEvent } from './p-X1tirp06.js';
...
const ModusWcPagination = /*@__PURE__*/ proxyCustomElement(class ModusWcPagination extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return modusWcPaginationCss; }
}, [0, "modus-wc-pagination", {
        "ariaLabelValues": [16, "aria-label-values"],
        "count": [2],
        "customClass": [1, "custom-class"],
        "nextButtonText": [1, "next-button-text"],
        "page": [2],
        "prevButtonText": [1, "prev-button-text"],
        "size": [1],
        "visiblePages": [32]
    }, undefined, {
        "page": ["calculateVisiblePages"],
...
function defineCustomElement() {
    ...
    const components = ["modus-wc-pagination"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-wc-pagination":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusWcPagination);
            }
            break;
    } });
}

export { ModusWcPagination as M, defineCustomElement as d };
