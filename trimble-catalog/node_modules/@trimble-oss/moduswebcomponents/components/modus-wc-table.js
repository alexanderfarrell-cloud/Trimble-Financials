...
import { d as defineCustomElement$7 } from './p-CeZm3cg9.js';
import { d as defineCustomElement$6 } from './p-vnbqBzVH.js';
import { d as defineCustomElement$5 } from './p-Bfy1MXxF.js';
import { d as defineCustomElement$4 } from './p-CqPlhPZ4.js';
import { d as defineCustomElement$3 } from './p-1kGp9yzr.js';
import { d as defineCustomElement$2 } from './p-DZIuODh4.js';
...
const ModusWcTable$1 = /*@__PURE__*/ proxyCustomElement(class ModusWcTable extends H {
    constructor() {
        super();
        this.__registerHost();
        this.cellEditStart = createEvent(this, "cellEditStart");
        this.cellEditCommit = createEvent(this, "cellEditCommit");
        this.rowClick = createEvent(this, "rowClick");
        this.sortChange = createEvent(this, "sortChange");
        this.paginationChange = createEvent(this, "paginationChange");
        this.rowSelectionChange = createEvent(this, "rowSelectionChange");
    ...
    render() {
        ...
        const totalPages = this.getTotalPages();
        return (h(Host, { key: '959024dd01c195e90c75f9e2aa3060375d9bf285' }, h("div", { key: 'feffa7545e9d5a9e06a52754ab99a0a087d90203', class: "table-container" }, h("div", Object.assign({ key: '213549102b0d224d9c2b17b1bb3e7e2bb799fe1c', class: "modus-wc-overflow-x-auto" }, this.inheritedAttributes), h("table", { key: 'c1431468a72bc08fef01b326ab9a55f40b70d1b0', class: this.getClasses() }, this.caption && (h("caption", { key: '651687f6b997f44a0593443e8369ed0341f87165', class: "modus-wc-sr-only" }, this.caption)), h("thead", { key: '77a5455636ab60be9018be7ce0458e23f3ca6ad0' }, h("tr", { key: '51a36d3d0f917e9bf7f8558e5f7df60756e0778e' }, this.selectable !== 'none' && (h("th", { key: 'aeb1c88b1db43bbbf06a9b0587bf56df1c3e0e96', class: "selection-column", style: { width: '48px' } }, this.selectable === 'multi' && this.table && (h("modus-wc-checkbox", { key: 'a5bc21a4e34a3a173300300f74f54ebda99ee56d', "aria-label": "Select all rows", size: "sm", value: this.table.getIsAllRowsSelected(), indeterminate: this.table.getIsSomeRowsSelected() &&
            ...
            }))), h("tbody", { key: '9ca8408a5c623eb794ea50a75eea54646fcfd990' }, displayData.length > 0 ? (rows.map((rowObj, index) => {
            var _a, _b, _c, _d, _e;
            ...
            return (h("tr", { key: (_a = rowObj.id) !== null && _a !== void 0 ? _a : `row-${index}`, class: {
                ...
                (this.selectable !== 'none' ? 1 : 0), class: "no-data-message" }, "No data available")))))), this.paginated && ((_c = this.data) === null || _c === void 0 ? void 0 : _c.length) > 0 && (h("div", { key: '27edbc63891bd50a2d950a3bc06197c098acbb03', class: "pagination-container" }, this.renderPageSizeSelector(), this.renderPaginationInfo(), h("div", { key: 'b895ed15961f139d02ee6868d2048db4bc519d9b', class: "pagination-controls" }, h("modus-wc-pagination", { key: '010302d24c38beabc777685f2a3c9ee4777ce1a0', count: totalPages, page: this.internalPagination.pageIndex + 1, size: this.getPaginationSize(), onPageChange: (e) => this.handlePageChange(Number(e.detail.newPage)) })))))));
    }
    get el() { return this; }
    ...
    static get style() { return modusWcTableCss; }
}, [0, "modus-wc-table", {
        "editable": [4],
        "columns": [16],
        ...
        "paginated": [4],
        "pageSizeOptions": [16, "page-size-options"],
        "showPageSizeSelector": [4, "show-page-size-selector"],
        "sortable": [4],
        "selectable": [1],
        "selectedRowIds": [16, "selected-row-ids"],
        "zebra": [4],
        "caption": [1],
        "activeEditor": [32],
        "sorting": [32],
        "internalPagination": [32],
        "internalRowSelection": [32]
    }, undefined, {
        "currentPage": ["handleCurrentPageChange"],
        "data": ["handleDataChange"],
        "columns": ["handleColumnsChange"],
...
function defineCustomElement$1() {
    ...
    const components = ["modus-wc-table", "modus-wc-checkbox", "modus-wc-icon", "modus-wc-input-feedback", "modus-wc-input-label", "modus-wc-pagination", "modus-wc-select"];
    components.forEach(tagName => { switch (tagName) {
        case "modus-wc-table":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ModusWcTable$1);
            }
            break;
...
const ModusWcTable = ModusWcTable$1;
const defineCustomElement = defineCustomElement$1;

export { ModusWcTable, defineCustomElement };
